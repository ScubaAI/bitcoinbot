    ...
    return (
        <div className="min-h-screen bg-[#0a0a0a] p-6 text-gray-300 font-mono">
            <div className="max-w-6xl mx-auto">
                ...
                <p className="text-xs text-[#F7931A]/70 mb-8">
                    Fee rate actual: {feeRate} sat/vB
                </p>
                ...
                <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
                    ...
                    <TerminalWindow title="builder-agent.sh">
                        <div className="space-y-6">
                            ...
                            >
                                {!wallet ? 'GENERATE WALLET FIRST' : balance < 1000 ? 'NEEDS 1000+ SATS' : `PREPARE BEACON (${feeRate} sat/vB)`}
                            </button>
                        </div>
                    </TerminalWindow>
